...
stream-rt: examples/stream-rt/stream-rt.cpp $(SRC_COMMON) $(SRC_COMMON_SDL) $(WHISPER_OBJ)
		$(CXX) $(CXXFLAGS) examples/stream-rt/stream-rt.cpp $(SRC_COMMON) $(SRC_COMMON_SDL) $(WHISPER_OBJ) -o stream-rt $(CC_SDL) $(LDFLAGS)
